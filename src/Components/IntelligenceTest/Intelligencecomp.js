...
const IntelligenceComp=()=>{
    ...
    async function SubmitHandler() {
        ...
        const Response = await fetch('https://iamadityachakraborty.pythonanywhere.com/FetchIntelligenceQsn');
    ...
    async function IntelligenceScoreSubmit(){
        ...
        //https://iamadityachakraborty.pythonanywhere.com/ <---Replace this before build
        const SendData = await fetch('https://iamadityachakraborty.pythonanywhere.com/GetIntelligenceResult',{
            method:"POST",
    ...
    useEffect(()=>{
        let Text = "We are interested in knowing more about you. Please tell us about the things you like by completing the Multiple intelligence and the Interest Inventory Lists, Click on the start button"
        Say(Text);
    },[]);
    ...
    return(
        ...
        <div className="SentenceStartscrrencontains" style={{position:"relative",width:"100%",height:"60%",marginTop:"20%"}}>
            <p style = {{ color: "white", fontSize: "12px" }} > Note: You will have a Intelligence test, </p> 
            ...
            <div className = "SentenceInstructions">
                    <button onClick = {() => speak({ text: "We are interested in knowing more about you. Please tell us about the things you like by completing the Multiple intelligence and the Interest Inventory Lists, Click on the start button" })} className = "SpeakerInstructions" > <i className = "fas fa-volume-up" > </i></button>
            </div>
...
export default IntelligenceComp;