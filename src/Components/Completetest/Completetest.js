...
//mport LogoutComp from "../Logout/Logout";
...
const CompleteTestPage=()=>{
    ...
    async function RequestRetake(){
        ...
        const SentenceApiResp = await fetch("https://iamadityachakraborty.pythonanywhere.com/Retake",{
            method:"POST",
    ...
    async function FetchScores(){
        ...
        const PretestResultResp = await fetch("https://iamadityachakraborty.pythonanywhere.com/PretestResults",{
            method:"POST",
            body:JSON.stringify(UserData),
            headers: {
                'Content-Type': 'application/json',
