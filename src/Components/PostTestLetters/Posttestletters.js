...
import PostTestLetterShowComp from "./posttestletterscomp";
import { useNavigate } from "react-router-dom";
//import LogoutComp from "../Logout/Logout";


const PostLettersPretestPage=()=>{
    ...
    if (LocalStorageItem !== null) {
        return(
            <div id="Pretest">
                ...
                <div id="PretestGroup">
                    <PostTestLetterShowComp></PostTestLetterShowComp>
                </div>
            </div>
        );
    }else{
...
export default PostLettersPretestPage;